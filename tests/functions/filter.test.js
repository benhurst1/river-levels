const { filterStations } = require("../../functions/collectStations.js");
...
describe("filterStations", () => {
  it("should filter and transform the stations data correctly", () => {
    ...
    // Check that the result is not the same as the original data
    expect(result.items).not.toBe(stationsData.items);
